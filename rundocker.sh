...
test -d ${VOL_CONFIG} || echo "Created ${VOL_CONFIG}" && mkdir -p ${VOL_CONFIG}
test -d ${VOL_DOWNLOADS} || echo "Created ${VOL_DOWNLOADS}" && mkdir -p ${VOL_DOWNLOADS}
test -d ${VOL_INCOMPLETE_DOWNLOADS} || echo "Created ${VOL_INCOMPLETE_DOWNLOADS}" && mkdir -p ${VOL_INCOMPLETE_DOWNLOADS}
